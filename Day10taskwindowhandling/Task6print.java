...
public class Task6print {

	public static void main(String[] args) throws InterruptedException, AWTException {
		// (//i[@class='fas fa-plus'])[6]
		...
		WebElement printtext = driver.findElement(By.xpath("(//td[@class='line-content'])[37]"));
		String text = printtext.getText();
		System.out.println("first question practical:"+text);
	}
